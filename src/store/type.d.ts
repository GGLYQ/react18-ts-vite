...
interface reducerIState {
  ...
  gisWholeReducer: { screenMode: number, excuteMapMethod: IObj, firstGisScreen: IObj, secondGisScreen: IObj, thirdGisScreen: IObj, fourthGisScreen: IObj, fifthGisScreen: IObj }
}
