let toolbarList = {
  leftList: [
    ...
    { id: 'plotting', label: '标绘', icon: 'icon-gis_biaohui', panelType: 'left' },
    { id: 'ranging', label: '测距', icon: 'icon-shujushujudian' },
    { id: 'surfaceMeasurement', label: '测面', icon: 'icon-bianjietiaojian' },
    { id: 'attributeQuery', label: '属性', icon: 'icon-dietu', panelType: 'right'  },
    { id: 'dataOverlay', label: '数据叠加', icon: 'icon-dietumoshi', panelType: 'right' },
  ],
  rightList: [
